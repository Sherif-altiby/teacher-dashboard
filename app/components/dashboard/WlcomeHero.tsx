...
export const WelcomeHero = () => {
  ...
  return (
    <div className="relative overflow-hidden rounded-4xl bg-linear-to-br from-[#5700FF] via-[#7000FF] to-[#8A00FF] p-8 shadow-[0_20px_50px_rgba(87,0,255,0.2)]">
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        ...
        <div className="space-y-3 text-right md:text-right"  >
          <h1 className="text-3xl! md:text-5xl font-extrabold text-white leading-[1.2]">
            أهلاً بك مجدداً، <br />
        ...
        {/* Date Glass-Badge */}
        <div className="group bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-5 flex items-center gap-5 text-white transition-all hover:bg-white/15">
          ...
          <div className="flex flex-col gap-1">
            ...
            <span className="text-base font-bold tracking-tight">{today}</span>
          </div>
        </div>
      </div>
    </div>
