    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <Link href="/quizzes" className="flex items-center gap-2 text-slate-400 hover:text-indigo-600 transition-colors mb-4 text-xs font-bold">
            <ArrowRight size={16} />
            العودة للاختبارات
          </Link>
          <h1 className="text-xl font-black text-slate-900">نتائج الاختبار</h1>
          <p className="text-slate-500 text-sm mt-1">تحليل أداء الطلاب وتفاصيل الإجابات</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-10">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
          <div className="p-6 border-b border-slate-50 flex justify-between items-center">
            <h2 className="text-base font-bold text-slate-800 text-right">قائمة الطلاب</h2>
            <div className="text-xs text-slate-400 font-medium">عرض {data.length} نتيجة</div>
          </div>
            ...
            <table className="w-full text-right">
              <thead className="bg-slate-50/50 text-slate-400 text-[11px] uppercase tracking-wider">
                <tr>
                  ...
                  <th className="px-6 py-3 font-bold">الإجابات الصحيحة</th>
                  <th className="px-6 py-3 font-bold">الدرجة النهائية</th>
